...
export const SHADCN_CONFIGURATION = {
...
export const TAILWIND_CONFIG = `const { createGlobPatternsForDependencies } = require('@nx/react/tailwind');
...
export const TAILWIND_GLOBAL_CSS_CONFIGURATION = `
@tailwind base;
@tailwind components;
@tailwind utilities;
